...
export declare class BatchRenderer {
	...
	push(primitive: GLenum, verts: number[], indices: number[], shader: Shader, tex?: Texture | null, uniform?: Uniform | null): void;
	flush(): void;
	free(): void;
}
